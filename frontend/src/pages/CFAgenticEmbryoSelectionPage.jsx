...
// Custom Feature: Agentic embryo selection
// Agentic embryo selection: Multi-modal scoring (morphology images, genetic test results, age/health factors, preferences); AI recommends best embryo transfer order; generates counseling summary
import React, { useState } from 'react';

export default function CFAgenticEmbryoSelectionPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-agentic-embryo-selection/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Agentic embryo selection</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Agentic embryo selection: Multi-modal scoring (morphology images, genetic test results, age/health factors, preferences); AI recommends best embryo transfer order; generates counseling summary</p>
