...
export default function GapGeneticPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-genetic/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Genetic</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Genetic-screenings without /genetic-risk-assess-ai (disease predisposition analysis)</p>
