...
// Gap (Non-AI): Limited frontend pages (15) for 21
// Limited frontend pages (15) for 21-route backend
import React, { useState } from 'react';

export default function GapLimitedFrontendPages15For21Page() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-limited-frontend-pages-15-for-21/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Limited frontend pages (15) for 21</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Limited frontend pages (15) for 21-route backend</p>
