...
export default function GapAiRouteStubsAiPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-ai-route-stubs-ai/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>AI route stubs (ai</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>AI route stubs (ai-reports, ai-scores, predictions) need real model integration</p>
