...
// Custom Feature: Cycle protocol optimization
// Cycle protocol optimization: Patient ovarian reserve, age, prior responses; AI recommends medication protocols most likely to succeed
import React, { useState } from 'react';

export default function CFCycleProtocolOptimizationPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-cycle-protocol-optimization/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Cycle protocol optimization</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Cycle protocol optimization: Patient ovarian reserve, age, prior responses; AI recommends medication protocols most likely to succeed</p>
