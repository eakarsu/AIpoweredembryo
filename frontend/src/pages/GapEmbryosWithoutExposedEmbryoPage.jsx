...
// Gap (AI): Embryos without exposed '/embryo
// Embryos without exposed /embryo-scoring-ai (combined grading: morphology, genetic risk)
import React, { useState } from 'react';

export default function GapEmbryosWithoutExposedEmbryoPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-embryos-without-exposed-embryo/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Embryos without exposed '/embryo</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Embryos without exposed /embryo-scoring-ai (combined grading: morphology, genetic risk)</p>
