...
// Custom Feature: Genetic disease screening assistant
// Genetic disease screening assistant: Rare variant detected; AI searches literature, suggests counseling points, flags if family history relevant
import React, { useState } from 'react';

export default function CFGeneticDiseaseScreeningAssistantPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-genetic-disease-screening-assistant/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Genetic disease screening assistant</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Genetic disease screening assistant: Rare variant detected; AI searches literature, suggests counseling points, flags if family history relevant</p>
