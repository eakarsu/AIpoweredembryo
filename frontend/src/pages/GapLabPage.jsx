...
export default function GapLabPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-lab/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Lab</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Lab-results without /lab-anomaly-detect (flag out-of-range results)</p>
